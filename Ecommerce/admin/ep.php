...
<div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="file" id="product_image2" name="product_image2"
             class="form-control w-90 m-auto" required="required">
             <img src="./product_images/<?php echo $product_image2?>p" alt="" class="product_img">
            </div>         
</div>
<div class="form-outline w-50 m-auto mb-4">
            <label for="product_image3" class="form-label">Product Image3</label>
            <div class="d-flex">
            <input type="file" id="product_image2" name="product_image3"
             class="form-control w-90 m-auto" required="required">
...
<div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_price"  value="<?php echo $product_prize?>" name="product_price" class="form-control" 
            required="required">
</div>
...
if(isset($_POST['edit_product'])){
  ...
  if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands==''or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_prize==''){
...
echo "<script>alert('please fill all the fields and continue the process')</script>";
    ...
    product_description='$product_tdesc',product_keywords='$product_keywords',
    category_id='$product_category',brand_id='$product_brands', product_image1='$product_image1',product_image2='$product_image2',
    product_image3='$product_image3',product_prize='$product_prize',date=Now() where product_id=$edit_id";
