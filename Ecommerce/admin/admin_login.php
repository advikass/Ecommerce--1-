            ...
            <div class="col-lg-6 col-xl-4">
                <form action="" method="post">
                    <div class="for-outline mb-4">
                        <label for="username" class="form-label">adminrname</label>
                        <input type="text" id="username" name="adminname" placeholder="Enter username" required="required" class="form-control" autocomplete="off">
                    </div>
                    ...
                    <div>
                        <input type="submit" class="btn bg-info py-2 px-3 mb-2" name="admin_login" value="Login">
                    </div>
