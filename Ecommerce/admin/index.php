        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                ...
                <div class="button text-center ">
                    <button><a href="insert_product.php" class="nav-link text-dark bg-info my-1 px-1">Insert Products</a></button>
                    ...
                    <button><a href="index.php?view_categories" class="nav-link text-dark bg-info my-1 px-2">View Categories</a></button>
                    <button><a href="index.php?insert_brand" class="nav-link text-dark bg-info my-1 px-1">Insert Brands</a></button>
